            ...
            <div className="container-footer">
                ...
                <div className="enlaces">
                    ...
                    <ul>
                        ...
                        <li>
                            <Link to="/capacidades/asistencia">Asistencia Técnica Alpha</Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link to="/capacidades/academia">Gestion Pública</Link>
                        </li>
                        <li>
                            <Link to="/capacidades/academia">Aprendo Haciendo</Link>
                        </li>
                        <li>
                            <Link to="/blog">
                                <h3>Blog Alpha</h3>
                    ...
                    <ul>
                        ...
                        <li>
                            <Link to="/consultoria">Macro</Link>
                        </li>
                        <li>
                            <Link to="/consultoria">Micro</Link>
                        </li>
                        <li>
                            <Link to="/consultoria">Estructuración y Financiamiento de Proyectos</Link>
                        </li>
                        <li>
                            <Link to="/consultoria">IFD</Link>
                        </li>
                        <li>
                            <Link to="/consultoria">Peritajes</Link>
                        </li>
                    </ul>
                    </div>
