                        ...
                        <div className={`module-content ${openModule == index ? 'open' : ''}`}>
                                ...
                                <div className="sub-module">
                                    ...
                                    <div className={`sub-module-content ${openSubModules[0] ? 'open' : ''}`}>
                                        {modu.material.map((v, i) => (
                                            <a href={v} key={i} target="_blank" rel="noopener noreferrer"><LuFileDown /> Ver documento {i+1}</a>
                                        ))}
                                    </div>
                                </div>
                                {/* Ejercicios */}
                                <div className="sub-module">
                                    ...
                                    <div className={`sub-module-content ${openSubModules[1] ? 'open' : ''}`}>
                                        {modu.ejercicios.map((v, i) => (
                                            <a href={v} key={i} target="_blank" rel="noopener noreferrer"><LuFileEdit /> Ver ejercicio {i+1}</a>
                                        ))}
                                    </div>
                                </div>
                                {/* Videos */}
                                <div className="sub-module">
                                    ...
                                    <div className={`sub-module-content ${openSubModules[2] ? 'open' : ''}`}>
                                        {modu.videos.map((v, i) => (
                                            <a href={v} key={i} target="_blank" rel="noopener noreferrer"><LuMonitorPlay /> Ver video {i+1}</a>
                                        ))}
                                    </div>
                                </div>
